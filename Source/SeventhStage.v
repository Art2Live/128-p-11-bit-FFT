// -------------------------------------------------------------
// 
// File Name: hdlsrc2\FFTscheme2\SeventhStage.v
...
// 
// Module: SeventhStage
// Source Path: FFTscheme2/FFTv2/Butterflies/128 input 7 step/SeventhStage
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SeventhStage
  ...
  input   signed [9:0] Const_input;  // sfix10_En8
  ...
  assign Product_mul_temp = Const_input * In2_re;
  assign Product_out1_re = ((Product_mul_temp[22] == 1'b0) && (Product_mul_temp[21:20] != 2'b00) ? 12'sb011111111111 :
              ((Product_mul_temp[22] == 1'b1) && (Product_mul_temp[21:20] != 2'b11) ? 12'sb100000000000 :
              $signed(Product_mul_temp[20:9])));
  assign Product_mul_temp_1 = Const_input * In2_im;
  assign Product_out1_im = ((Product_mul_temp_1[22] == 1'b0) && (Product_mul_temp_1[21:20] != 2'b00) ? 12'sb011111111111 :
